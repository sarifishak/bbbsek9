  ...
  <div class="">
    <div class="page-title">
      <div class="title_left">
        <!-- <h3>Senarai bayaran keselamatan ( 5 bayaran terakhir) </h3> --> 
        <h3>&nbsp;</h3>
      </div>
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Senarai bayaran keselamatan ( 5 bayaran terakhir) </h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
                        ...
                        <div class="product-image-wrapper">
                            <div class="single-products">
                                <div class="productinfo text-center">
                                    ...
                                    <p><?php echo $contact->noRumah.','.$contact->jalan ?></p>
                                    <p>
                                    <?php
                                    foreach($contact->receivedPaymentList as $receivedPayment) {
                                        $paymentDate = date_create($receivedPayment->feeFor);
                                        echo '<p>"Receipt '.$receivedPayment->receiptNo.'" for '.date_format($paymentDate,"F, Y").'<br>';
                                    }
                                    ?></p>
                                </div>
                            </div>
